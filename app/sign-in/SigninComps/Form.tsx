            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-4">
                    <div className="flex items-center space-x-2">
                        <input type="checkbox" className="w-4 h-4 border-indigo-500" />
                ...
                <div className="w-full flex items-center mx-auto justify-center">
                    <p className="text-slate-600 text-center text-base font-primary">Don’t have an account?</p><p className="text-indigo-500 text-base font-primary">&nbsp; <Link href="/sign-up">Sign up</Link></p>
                </div>
            </div>

    ...
    return (
        <div className="w-full h-full space-y-24 dark:bg-[#1E1A1A]">
            <div className="flex items-center w-full space-x-7">
                ...
                <input type="number" value={withdrawAmt} onChange={handleChange} placeholder="0" className="w-full dark:text-white bg-transparent border-none text-slate-600 text-5xl font-black focus:outline-none selection:outline-none focus:border-none" />
            </div>

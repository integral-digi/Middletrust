        ...
        <div className="w-full h-max space-y-6">
            ...
            <div className="grid grid-cols-4 w-[100%] gap-x-16">
                <div className="block justify-center space-y-7">
                    ...
                    <p className="text-center text-slate-600 dark:text-white text-base font-primary relative">{userContacts[0].name}</p>
                </div>
                <div className="block space-y-7 justify-center">
                    <img 
                        ...
                        className="w-16 h-16 rounded-full border-4 border-gray-300 items-center mx-auto" />
                    <p className="text-center text-slate-600 dark:text-white text-base font-primary">{userContacts[1].name}</p>
                </div>
                <div className="block justify-center space-y-7">
                    <img 
                    ...
                    <p className="text-center text-slate-600 dark:text-white text-base font-primary">{userContacts[2].name}</p>
                </div>
                <div className="block justify-center space-y-7">
                    <img 
                        ...
                        className="w-16 h-16 rounded-full border-4 border-gray-300" />
                    <p className="text-center text-slate-600 dark:text-white text-base font-primary">{userContacts[3].name}</p>
                </div>
            </div>
        </div>
    );

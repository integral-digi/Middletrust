                            ...
                            <div className="space-x-6 flex items-center">
                                <Popover data-popover-target={`right-flyout-${userData.id}`}>
                                    ...
                                    <Transition
                                        ...
                                        >
                                        <Popover.Panel className="z-50 top-0 right-0 w-max h-max absolute" id={`right-flyout-${userData.id}`}>
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-600 dark:text-white text-xs font-primary">{userData.lastTxn.time}</p>
                                </div>
                            </div>
                        </div>
                        <div className="flex items-center top-0">
                            <div className="text-right">
                                <p className="text-slate-600 dark:text-white text-base font-secondary">{formattedCurr(userData.lastTxn.amount)}</p>
                            </div>
                            <div>
